...
public class MainTabActivity2 extends ActivityGroup{
	...
	public void prepareIntent(){
		...
		mHomeIntent = new Intent(MainTabActivity2.this,HomeActivity.class);
		mElementIntent = new Intent(MainTabActivity2.this,GoodsActivity.class);
		mEquipmentIntent = new Intent(MainTabActivity2.this,EquipmentActivity.class);
		mUserIntent = new Intent(MainTabActivity2.this,UserActivity.class);
		mMoreIntent = new Intent(MainTabActivity2.this,MoreActivity.class);
	}
