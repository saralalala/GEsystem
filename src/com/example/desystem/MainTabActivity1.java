...
public class MainTabActivity1 extends ActivityGroup{
	...
	public void prepareIntent(){
		...
		mHomeIntent = new Intent(MainTabActivity1.this,HomeActivity.class);
		mElementIntent = new Intent(MainTabActivity1.this,GoodsListActivity.class);
		mEquipmentIntent = new Intent(MainTabActivity1.this,EquipmentListActivity.class);
		mUserIntent = new Intent(MainTabActivity1.this,UserActivity.class);
		mMoreIntent = new Intent(MainTabActivity1.this,MoreActivity.class);
	}
